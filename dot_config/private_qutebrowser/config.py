...
# list) will work.
# Type: List of String
c.qt.args = ["disable-features=WebAuth"]
...
# always the global value.
# Type: FormatString
c.content.headers.user_agent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36"
...
config.set(
    ...
    True,
    "file:///home/nihilistzsche/.local/share/qutebrowser/userscripts/*",
)
...
config.bind(
    "<Alt+p",
    'spawn --userscript qute-pass --dmenu-invocation "rofi -dmenu -display-backend wayland"',
)
